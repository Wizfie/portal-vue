...
<template>
	<div>
		...
		<div class="p-4 sm:ml-64">
			...
			<div
				class="p-4 border-2 flex justify-between border-gray-200 border-opacity-100 rounded-lg dark:border-gray-700 mt-5"
			>
				<div>
					<!-- Button Group -->
					<!-- Modal toggle -->
					<button
						data-modal-target="qcc-modal"
						data-modal-toggle="qcc-modal"
